...
export const getControlBoardPlanningDetailRule = [
	param("controlBoardPlanningId")
		.notEmpty()
		.withMessage("Planning id cannot be null")
		.isUUID("4")
...
export const createControlBoardPlanningRule = [
	body("planning")
		.notEmpty()
		.withMessage("Planning cannot be null")
		.isObject()
		.withMessage("Invalid planning type"),
	body("planningDetails")
		.notEmpty()
		.withMessage("Planning Detail cannot be null")
		.isArray()
